...
_SRC	=	ft_strlen.c ft_isalpha.c ft_isalnum.c ft_isdigit.c ft_isascii.c \
		...
		ft_isupper.c ft_islower.c ft_itoa.c ft_itoa_base_u.c ft_putchar_fd.c \
		ft_putendl_fd.c ft_putnbr_fd.c ft_putstr_fd.c ft_strmapi.c \
		ft_strtrim.c ft_atoi.c ft_split.c ft_lstnew.c ft_lstadd_front.c \
